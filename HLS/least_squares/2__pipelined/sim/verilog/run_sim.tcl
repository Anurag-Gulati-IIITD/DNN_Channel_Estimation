...
if {[file isfile LS_estimator.autotvin.dat]} {
	file delete -force LS_estimator.autotvin.dat
}

if {[file isfile LS_estimator.autotvout.dat]} {
	file delete -force LS_estimator.autotvout.dat
}
