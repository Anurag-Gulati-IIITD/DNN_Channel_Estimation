...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.LS_estimator.autotvin_in_stream_V_data.dat"
         "c.LS_estimator.autotvin_in_stream_V_last_V.dat"
         "c.LS_estimator.autotvin_out_stream_V_data.dat"
         "c.LS_estimator.autotvin_out_stream_V_last_V.dat"
         "c.LS_estimator.autotvout_out_stream_V_data.dat"
         "c.LS_estimator.autotvout_out_stream_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.LS_estimator.autotvout_out_stream_V_data.dat"
         "rtl.LS_estimator.autotvout_out_stream_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
