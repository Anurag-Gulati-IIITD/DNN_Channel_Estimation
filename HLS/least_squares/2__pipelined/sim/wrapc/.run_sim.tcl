...
# ==============================================================
set ::env(PATH) "$::env(PATH);D:/Softwares/Xilinx/Vivado/Vivado/2019.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);D:/Softwares/Xilinx/Vivado/Vivado/2019.1/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);D:/Softwares/Xilinx/Vivado/Vivado/2019.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);D:/Softwares/Xilinx/Vivado/Vivado/2019.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/Softwares/Xilinx/Vivado/Vivado/2019.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "LS_estimator.autotvin.dat"
	set constFileTvOut       "LS_estimator.autotvout.dat"
	set constFileHdlTvIn     "LS_estimator.autohdltvin.dat"
	set constFileHdlTvOut    "LS_estimator.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
