...
if {[file isfile DNN_wlo_166.autotvin.dat]} {
	file delete -force DNN_wlo_166.autotvin.dat
}

if {[file isfile DNN_wlo_166.autotvout.dat]} {
	file delete -force DNN_wlo_166.autotvout.dat
}
