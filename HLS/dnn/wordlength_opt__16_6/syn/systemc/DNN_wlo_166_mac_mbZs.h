...
// ==============================================================
#ifndef __DNN_wlo_166_mac_mbZs__HH__
#define __DNN_wlo_166_mac_mbZs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DNN_wlo_166_mac_mbZs) {
    ...
    SC_CTOR(DNN_wlo_166_mac_mbZs):  simcore_mac_2_U ("simcore_mac_2_U") {
