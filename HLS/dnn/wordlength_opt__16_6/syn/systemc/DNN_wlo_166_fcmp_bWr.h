...
// ==============================================================
#ifndef __DNN_wlo_166_fcmp_bWr__HH__
#define __DNN_wlo_166_fcmp_bWr__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(DNN_wlo_166_fcmp_bWr) {
    ...
    SC_CTOR(DNN_wlo_166_fcmp_bWr):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
