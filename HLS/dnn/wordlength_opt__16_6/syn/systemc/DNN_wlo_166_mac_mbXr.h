...
// ==============================================================
#ifndef __DNN_wlo_166_mac_mbXr__HH__
#define __DNN_wlo_166_mac_mbXr__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DNN_wlo_166_mac_mbXr) {
    ...
    SC_CTOR(DNN_wlo_166_mac_mbXr):  simcore_mac_0_U ("simcore_mac_0_U") {
