...
// ==============================================================
#ifndef __DNN_wlo_166_mac_mcTB__HH__
#define __DNN_wlo_166_mac_mcTB__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DNN_wlo_166_mac_mcTB) {
    ...
    SC_CTOR(DNN_wlo_166_mac_mcTB):  simcore_mac_5_U ("simcore_mac_5_U") {
