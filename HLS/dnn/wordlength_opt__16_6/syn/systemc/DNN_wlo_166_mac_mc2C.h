...
// ==============================================================
#ifndef __DNN_wlo_166_mac_mc2C__HH__
#define __DNN_wlo_166_mac_mc2C__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DNN_wlo_166_mac_mc2C) {
    ...
    SC_CTOR(DNN_wlo_166_mac_mc2C):  simcore_mac_11_U ("simcore_mac_11_U") {
