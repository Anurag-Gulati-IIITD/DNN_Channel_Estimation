...
// ==============================================================
#ifndef __DNN_wlo_166_mac_mcUB__HH__
#define __DNN_wlo_166_mac_mcUB__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DNN_wlo_166_mac_mcUB) {
    ...
    SC_CTOR(DNN_wlo_166_mac_mcUB):  simcore_mac_6_U ("simcore_mac_6_U") {
