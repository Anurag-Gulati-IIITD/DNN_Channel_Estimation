...
// ==============================================================
#ifndef __DNN_wlo_166_mac_mcSB__HH__
#define __DNN_wlo_166_mac_mcSB__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DNN_wlo_166_mac_mcSB) {
    ...
    SC_CTOR(DNN_wlo_166_mac_mcSB):  simcore_mac_4_U ("simcore_mac_4_U") {
