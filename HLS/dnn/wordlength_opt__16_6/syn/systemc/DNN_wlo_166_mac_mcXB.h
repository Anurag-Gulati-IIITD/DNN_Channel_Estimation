...
// ==============================================================
#ifndef __DNN_wlo_166_mac_mcXB__HH__
#define __DNN_wlo_166_mac_mcXB__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DNN_wlo_166_mac_mcXB) {
    ...
    SC_CTOR(DNN_wlo_166_mac_mcXB):  simcore_mac_9_U ("simcore_mac_9_U") {
