...
// ==============================================================
#ifndef __DNN_wlo_166_mac_mbYs__HH__
#define __DNN_wlo_166_mac_mbYs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DNN_wlo_166_mac_mbYs) {
    ...
    SC_CTOR(DNN_wlo_166_mac_mbYs):  simcore_mac_1_U ("simcore_mac_1_U") {
