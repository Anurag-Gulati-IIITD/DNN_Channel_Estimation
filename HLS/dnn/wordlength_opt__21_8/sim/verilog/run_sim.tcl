...
if {[file isfile DNN_wlo_218.autotvin.dat]} {
	file delete -force DNN_wlo_218.autotvin.dat
}

if {[file isfile DNN_wlo_218.autotvout.dat]} {
	file delete -force DNN_wlo_218.autotvout.dat
}
