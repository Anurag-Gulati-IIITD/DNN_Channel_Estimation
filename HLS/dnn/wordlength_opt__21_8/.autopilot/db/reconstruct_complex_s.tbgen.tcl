...
set C_modelArgList {
	{ y_L3_V int 21 regular {array 104 { 1 1 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "y_L3_V", "interface" : "memory", "bitwidth" : 21, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "y_L3_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":21, "type": "signal", "bundle":{"name": "y_L3_V", "role": "q0" }} , 
 	...
 	{ "name": "y_L3_V_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":21, "type": "signal", "bundle":{"name": "y_L3_V", "role": "q1" }} , 
...
set Spec2ImplPortList { 
	y_L3_V { ap_memory {  { y_L3_V_address0 mem_address 1 7 }  { y_L3_V_ce0 mem_ce 1 1 }  { y_L3_V_q0 mem_dout 0 21 }  { y_L3_V_address1 MemPortADDR2 1 7 }  { y_L3_V_ce1 MemPortCE2 1 1 }  { y_L3_V_q1 MemPortDOUT2 0 21 } } }
