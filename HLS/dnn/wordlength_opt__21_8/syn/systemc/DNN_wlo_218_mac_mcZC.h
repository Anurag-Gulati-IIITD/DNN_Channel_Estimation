...
// ==============================================================
#ifndef __DNN_wlo_218_mac_mcZC__HH__
#define __DNN_wlo_218_mac_mcZC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DNN_wlo_218_mac_mcZC) {
    ...
    SC_CTOR(DNN_wlo_218_mac_mcZC):  simcore_mac_11_U ("simcore_mac_11_U") {
