...
// ==============================================================
#ifndef __DNN_wlo_218_mac_mcVB__HH__
#define __DNN_wlo_218_mac_mcVB__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DNN_wlo_218_mac_mcVB) {
    ...
    SC_CTOR(DNN_wlo_218_mac_mcVB):  simcore_mac_7_U ("simcore_mac_7_U") {
