...
// ==============================================================
#ifndef __DNN_wlo_218_mac_mb0s__HH__
#define __DNN_wlo_218_mac_mb0s__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DNN_wlo_218_mac_mb0s) {
    ...
    SC_CTOR(DNN_wlo_218_mac_mb0s):  simcore_mac_3_U ("simcore_mac_3_U") {
