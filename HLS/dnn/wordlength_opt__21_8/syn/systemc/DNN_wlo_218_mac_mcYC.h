...
// ==============================================================
#ifndef __DNN_wlo_218_mac_mcYC__HH__
#define __DNN_wlo_218_mac_mcYC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DNN_wlo_218_mac_mcYC) {
    ...
    SC_CTOR(DNN_wlo_218_mac_mcYC):  simcore_mac_10_U ("simcore_mac_10_U") {
