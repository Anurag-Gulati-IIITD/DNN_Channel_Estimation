...
// ==============================================================
#ifndef __DNN_wlo_218_fpextbkb__HH__
#define __DNN_wlo_218_fpextbkb__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(DNN_wlo_218_fpextbkb) {
    ...
    SC_CTOR(DNN_wlo_218_fpextbkb):  ACMP_fpext_U ("ACMP_fpext_U") {
