...
// ==============================================================
#ifndef __DNN_wlo_218_mac_mcWB__HH__
#define __DNN_wlo_218_mac_mcWB__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DNN_wlo_218_mac_mcWB) {
    ...
    SC_CTOR(DNN_wlo_218_mac_mcWB):  simcore_mac_8_U ("simcore_mac_8_U") {
