...
set C_modelName {normalize_wlo}
set C_modelType { int 1664 }
set C_modelArgList {
	{ LS_data int 16 regular {array 104 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "LS_data", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ LS_data_q0 sc_in sc_lv 16 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "LS_data_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "LS_data", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.DNN_wlo_hsub_16nseOg_U7", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.DNN_wlo_hdiv_16nsfYi_U8", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	LS_data { ap_memory {  { LS_data_address0 mem_address 1 7 }  { LS_data_ce0 mem_ce 1 1 }  { LS_data_q0 mem_dout 0 16 } } }
}
