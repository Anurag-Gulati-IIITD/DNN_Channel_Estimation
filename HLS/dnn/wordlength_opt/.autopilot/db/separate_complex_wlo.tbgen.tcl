...
set C_modelArgList {
	...
	{ sep int 16 regular {array 104 { 0 0 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "LS_stream_V_data", "interface" : "axis", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sep", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sep_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "sep", "role": "d0" }} , 
 	...
 	{ "name": "sep_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "sep", "role": "d1" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.DNN_wlo_sptohp_32bkb_U1", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.DNN_wlo_sptohp_32bkb_U2", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	sep { ap_memory {  { sep_address0 mem_address 1 7 }  { sep_ce0 mem_ce 1 1 }  { sep_we0 mem_we 1 1 }  { sep_d0 mem_din 1 16 }  { sep_address1 MemPortADDR2 1 7 }  { sep_ce1 MemPortCE2 1 1 }  { sep_we1 MemPortWE2 1 1 }  { sep_d1 MemPortDIN2 1 16 } } }
}
