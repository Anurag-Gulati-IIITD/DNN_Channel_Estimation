...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "DNN_wlo.autotvin.dat"
	set constFileTvOut       "DNN_wlo.autotvout.dat"
	set constFileHdlTvIn     "DNN_wlo.autohdltvin.dat"
	set constFileHdlTvOut    "DNN_wlo.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
