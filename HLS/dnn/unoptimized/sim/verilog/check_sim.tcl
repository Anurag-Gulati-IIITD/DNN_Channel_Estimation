...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.DNN_u.autotvin_LS_stream_V_data.dat"
         "c.DNN_u.autotvin_LS_stream_V_last_V.dat"
         "c.DNN_u.autotvin_DNN_out_V_data.dat"
         "c.DNN_u.autotvin_DNN_out_V_last_V.dat"
         "c.DNN_u.autotvout_DNN_out_V_data.dat"
         "c.DNN_u.autotvout_DNN_out_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.DNN_u.autotvout_DNN_out_V_data.dat"
         "rtl.DNN_u.autotvout_DNN_out_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
