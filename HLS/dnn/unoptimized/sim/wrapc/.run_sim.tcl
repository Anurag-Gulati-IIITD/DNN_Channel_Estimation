...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "DNN_u.autotvin.dat"
	set constFileTvOut       "DNN_u.autotvout.dat"
	set constFileHdlTvIn     "DNN_u.autohdltvin.dat"
	set constFileHdlTvOut    "DNN_u.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
