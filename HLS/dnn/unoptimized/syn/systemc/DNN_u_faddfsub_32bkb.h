...
// ==============================================================
#ifndef __DNN_u_faddfsub_32bkb__HH__
#define __DNN_u_faddfsub_32bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(DNN_u_faddfsub_32bkb) {
    ...
    SC_CTOR(DNN_u_faddfsub_32bkb):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
