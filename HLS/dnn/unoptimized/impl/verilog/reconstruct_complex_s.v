...
wire   [6:0] zext_ln171_fu_86_p1;
wire   [6:0] add_ln174_fu_107_p2;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln171_fu_90_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if ((((icmp_ln171_fu_90_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2)) | ((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln171_fu_90_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
assign add_ln174_fu_107_p2 = (zext_ln171_fu_86_p1 + 7'd52);
...
assign icmp_ln171_fu_90_p2 = ((i_0_reg_75 == 6'd52) ? 1'b1 : 1'b0);

assign tmp_last_V_fu_118_p2 = ((i_0_reg_75 == 6'd51) ? 1'b1 : 1'b0);

assign y_L3_address0 = zext_ln174_fu_102_p1;

assign y_L3_address1 = zext_ln174_1_fu_113_p1;

assign zext_ln171_fu_86_p1 = i_0_reg_75;

assign zext_ln174_1_fu_113_p1 = add_ln174_fu_107_p2;

assign zext_ln174_fu_102_p1 = i_0_reg_75;
