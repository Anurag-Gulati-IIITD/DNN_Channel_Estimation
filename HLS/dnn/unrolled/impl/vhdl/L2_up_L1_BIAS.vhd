...
architecture rtl of L2_up_L1_BIAS_rom is 
...
architecture arch of L2_up_L1_BIAS is
    component L2_up_L1_BIAS_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    L2_up_L1_BIAS_rom_U :  component L2_up_L1_BIAS_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
