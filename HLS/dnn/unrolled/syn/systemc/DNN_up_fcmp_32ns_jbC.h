...
// ==============================================================
#ifndef __DNN_up_fcmp_32ns_jbC__HH__
#define __DNN_up_fcmp_32ns_jbC__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(DNN_up_fcmp_32ns_jbC) {
    ...
    SC_CTOR(DNN_up_fcmp_32ns_jbC):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
