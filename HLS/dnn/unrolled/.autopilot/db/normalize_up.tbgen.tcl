...
set C_modelName {normalize_up}
set C_modelType { int 3328 }
set C_modelArgList {
	{ LS_data float 32 regular {array 104 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "LS_data", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ LS_data_address0 sc_out sc_lv 7 signal 0 } 
	{ LS_data_ce0 sc_out sc_logic 1 signal 0 } 
	{ LS_data_q0 sc_in sc_lv 32 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "LS_data_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "LS_data", "role": "address0" }} , 
 	{ "name": "LS_data_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "LS_data", "role": "ce0" }} , 
 	{ "name": "LS_data_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "LS_data", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.DNN_up_fsub_32ns_cud_U4", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.DNN_up_fdiv_32ns_dEe_U5", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	LS_data { ap_memory {  { LS_data_address0 mem_address 1 7 }  { LS_data_ce0 mem_ce 1 1 }  { LS_data_q0 mem_dout 0 32 } } }
}
