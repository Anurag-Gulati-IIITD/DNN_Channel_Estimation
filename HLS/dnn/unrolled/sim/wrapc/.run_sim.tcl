...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "DNN_up.autotvin.dat"
	set constFileTvOut       "DNN_up.autotvout.dat"
	set constFileHdlTvIn     "DNN_up.autohdltvin.dat"
	set constFileHdlTvOut    "DNN_up.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
