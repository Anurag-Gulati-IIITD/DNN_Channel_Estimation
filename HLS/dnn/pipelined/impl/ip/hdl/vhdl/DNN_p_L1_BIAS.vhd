...
architecture rtl of DNN_p_L1_BIAS_rom is 
...
architecture arch of DNN_p_L1_BIAS is
    component DNN_p_L1_BIAS_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    DNN_p_L1_BIAS_rom_U :  component DNN_p_L1_BIAS_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
