...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "DNN_p.autotvin.dat"
	set constFileTvOut       "DNN_p.autotvout.dat"
	set constFileHdlTvIn     "DNN_p.autohdltvin.dat"
	set constFileHdlTvOut    "DNN_p.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
