...
proc create_root_design { parentCell } {
  ...
  # Create instance: DNN_u_0, and set properties
  set DNN_u_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:DNN_u:1.1 DNN_u_0 ]
  ...
  connect_bd_intf_net -intf_net DNN_u_0_DNN_out [get_bd_intf_pins DNN_u_0/DNN_out] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net LS_estimator_0_out_stream [get_bd_intf_pins DNN_u_0/LS_stream] [get_bd_intf_pins LS_estimator_0/out_stream]
