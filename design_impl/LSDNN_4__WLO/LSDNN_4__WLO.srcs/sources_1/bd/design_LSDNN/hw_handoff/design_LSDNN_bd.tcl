...
################################################################
# This is a generated script based on design: design_LSDNN
#
...
# source design_LSDNN_script.tcl
...
proc create_root_design { parentCell } {
  ...
  # Create instance: DNN_wlo_166_0, and set properties
  set DNN_wlo_166_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:DNN_wlo_166:1.1 DNN_wlo_166_0 ]

  # Create instance: LS_estimator_0, and set properties
  set LS_estimator_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:LS_estimator:1.1 LS_estimator_0 ]
  ...
  connect_bd_intf_net -intf_net DNN_wlo_166_0_DNN_out [get_bd_intf_pins DNN_wlo_166_0/DNN_out] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net LS_estimator_0_out_stream [get_bd_intf_pins DNN_wlo_166_0/LS_stream] [get_bd_intf_pins LS_estimator_0/out_stream]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins LS_estimator_0/in_stream] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
