...
################################################################
# This is a generated script based on design: bd_8a58
#
...
connect_bd_intf_net -intf_net Conn3 [get_bd_intf_ports SLOT_3_AXI] [get_bd_intf_pins g_inst/slot_3_axi]
  ...
  connect_bd_net -net net_slot_2_axi_bresp [get_bd_pins g_inst/m_slot_2_axi_bresp] [get_bd_pins ila_lib/probe18]
  ...
  connect_bd_net -net net_slot_2_axi_wstrb [get_bd_pins g_inst/m_slot_2_axi_wstrb] [get_bd_pins ila_lib/probe22]
  ...
  connect_bd_net -net net_slot_3_axi_ar_ctrl [get_bd_pins ila_lib/probe44] [get_bd_pins slot_3_ar/dout]
  ...
  connect_bd_net -net net_slot_3_axi_aw_ctrl [get_bd_pins ila_lib/probe41] [get_bd_pins slot_3_aw/dout]
  ...
  connect_bd_net -net net_slot_3_axi_b_ctrl [get_bd_pins ila_lib/probe43] [get_bd_pins slot_3_b/dout]
  ...
  connect_bd_net -net net_slot_3_axi_r_cnt [get_bd_pins g_inst/m_slot_3_axi_r_cnt] [get_bd_pins ila_lib/probe37]
  connect_bd_net -net net_slot_3_axi_r_ctrl [get_bd_pins ila_lib/probe45] [get_bd_pins slot_3_r/dout]
  connect_bd_net -net net_slot_3_axi_rdata [get_bd_pins g_inst/m_slot_3_axi_rdata] [get_bd_pins ila_lib/probe38]
  ...
  connect_bd_net -net net_slot_3_axi_rresp [get_bd_pins g_inst/m_slot_3_axi_rresp] [get_bd_pins ila_lib/probe39]
  connect_bd_net -net net_slot_3_axi_rvalid [get_bd_pins g_inst/m_slot_3_axi_rvalid] [get_bd_pins slot_3_r/In0]
  connect_bd_net -net net_slot_3_axi_w_ctrl [get_bd_pins ila_lib/probe42] [get_bd_pins slot_3_w/dout]
