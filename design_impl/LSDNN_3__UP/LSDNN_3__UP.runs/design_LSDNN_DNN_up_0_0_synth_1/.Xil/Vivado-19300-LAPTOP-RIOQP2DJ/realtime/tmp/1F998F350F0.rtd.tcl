...
set genomeRtd $env(RT_TMP)/1F998F350F0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {L2_up__GB0}]"
...
set genomeName [subst -nocommands -novariables {L2_up__GB0}]
